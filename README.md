...
- `short`: `false` by default because Coinbase spot cannot short. `true` simulates shorts that need futures or margin, and adds funding costs that are not modeled.
